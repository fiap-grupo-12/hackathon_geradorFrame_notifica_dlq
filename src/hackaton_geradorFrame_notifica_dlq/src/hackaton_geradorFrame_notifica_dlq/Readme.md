...
Execute unit tests
```
    cd "hackaton_geradorFrame_notifica_dlq/test/hackaton_geradorFrame_notifica_dlq.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "hackaton_geradorFrame_notifica_dlq/src/hackaton_geradorFrame_notifica_dlq"
